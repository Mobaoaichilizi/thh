...
class PublicController extends BaseController {
    ...
    public function login(){
        ...
        $chain_id=session('chain_user_id');

		if(!empty($chain_id))

		{

			redirect(U("Chain/index/index"));
	...
	public function dologin()
	{
		...
		if(!empty($result))
		{
			...
			{
				session('chain_user_id',$result['id']);
				session('chain_user_name',$result["username"]);
	...
	//退出登录
	 ...
	 public function logout(){
		...
		session('chain_user_id',null);
		
		session('chain_user_name',null);
