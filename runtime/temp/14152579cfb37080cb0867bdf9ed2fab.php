<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:82:"/www/web/toupiao_com/public_html/public/../application/admin/view/daoru/index.html";i:1592384851;}*/ ?>
            ...
            <div class="layui-row layui-col-space10 layui-form-item">
                <div class="layui-col-lg12">
                    ...
                    <div class="layui-input-block">
                        ...
                        <input type="number" name="number" lay-verify="required" placeholder="请输入投票增长数" autocomplete="off" class="layui-input" style="width: 30%;">
...
<script>
    ...
    $run(function(){
        ...
        form.on('submit(component-form-element)', function(data){
            ...
            post("<?php echo Url('Daoru/index'); ?>", data.field, function(ret){
