...
class Admin extends Model
{
     ...
     * @return array
     */
    public static function insertAdmin($param)
    {
        $model = new self;
        $param['admin_pwd'] = sp_password($param['admin_pwd']);
        $result =  $model->validate('Admin')->save($param);
        if(false === $result){
            // 验证失败 输出错误信息
     ...
     * @return array
     */
    public static function updateAdmin($param)
    {
        $model = new self;
