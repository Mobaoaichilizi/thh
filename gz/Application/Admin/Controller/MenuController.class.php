...
class MenuController extends AdminbaseController {
    ...
    public function index(){
        ...
        foreach ($result as $n=> $r) {
            $result[$n]['str_manage'] = '<a onclick="btn_edit('.$r['id'].')" class="LGQ_ico"><i class="fa fa-pencil-square-o"></i> 编辑</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a onclick="btn_delete('.$r['id'].')" class="LGQ_ico"><i class="fa fa-trash-o"></i> 删除</a>';
	...
	public function delMenu()
	{
		...
		$name=$this->menu->where("id=".$id)->getField("name");
		admin_log('del','menu',$name);
